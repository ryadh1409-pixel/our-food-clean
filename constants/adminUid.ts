...
/**
 * Client-side admin gate. Firestore profile fields are client-writable for normal
 * profile updates, so admin authority must come from Auth uid/email allowlists.
 */
